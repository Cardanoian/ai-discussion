...
import { Sparkles, BrainCircuit, ArrowRight, User } from 'lucide-react';
...
const MainView = () => {
  ...
  useEffect(() => {
    ...
    if (!loading && userProfile && !userProfile.avatar_url) {
          ...
          <DialogHeader>
            ...
            <DialogDescription className='space-y-2'>
              <span className='text-md'>
                프로필 사진이 아직 설정되지 않았습니다.
              </span>
              <br />
              <span className='text-sm'>
                프로필 페이지에서 아바타를 생성하고 개성 있는 프로필을
                완성해보세요!
              </span>
            </DialogDescription>
          </DialogHeader>
