    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900/50'>
      ...
      <div className='relative flex flex-col h-screen p-4 md:p-8'>
        ...
        <div className='flex justify-between items-center mb-8'>
          <h1 className='text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-500'>
            토론 자료 준비
          </h1>
        ...
        <div className='flex-grow flex flex-col'>
          <Card className='flex-grow animate-in fade-in-50 duration-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-0 shadow-2xl shadow-blue-500/10'>
            ...
            <CardHeader className='relative'>
              ...
              <CardDescription className='text-muted-foreground/80 text-base leading-relaxed mt-1'>
            ...
            <CardContent className='relative flex-grow flex flex-col'>
              ...
              <div className='flex justify-center items-center gap-4'>
                ...
                <Button
                  onClick={handleSave}
                  className='bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 group px-8 py-3'
                >
